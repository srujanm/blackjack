...
Global variables:
    ...
    CARD_DICT (dict {str, int}): dict generated by zipping the above two lists
...
class Deck:
    ...
    def draw(self):
        ...
        """
        if self.no_cards() == 0:
            raise Exception('Deck is empty. Cannot draw!')
        else:
            draw_no = random.randint(0,self.no_cards()-1)
            card_drawn = self.display()[draw_no]
